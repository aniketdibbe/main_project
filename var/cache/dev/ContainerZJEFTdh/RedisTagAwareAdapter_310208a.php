...
class RedisTagAwareAdapter_310208a extends \Symfony\Component\Cache\Adapter\RedisTagAwareAdapter implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'commit', array(), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->commit();
    }

    public function deleteItems(array $keys) : bool
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'deleteItems', array('keys' => $keys), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->deleteItems($keys);
    }

    public function invalidateTags(array $tags)
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'invalidateTags', array('tags' => $tags), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->invalidateTags($tags);
    }

    public function hasItem($key)
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'hasItem', array('key' => $key), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->hasItem($key);
    }

    public function clear(string $prefix = '')
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'clear', array('prefix' => $prefix), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->clear($prefix);
    }

    public function deleteItem($key)
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'deleteItem', array('key' => $key), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->deleteItem($key);
    }

    public function getItem($key)
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'getItem', array('key' => $key), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->getItem($key);
    }

    public function getItems(array $keys = [])
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'getItems', array('keys' => $keys), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->getItems($keys);
    }

    public function save(\Psr\Cache\CacheItemInterface $item)
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'save', array('item' => $item), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->save($item);
    }

    public function saveDeferred(\Psr\Cache\CacheItemInterface $item)
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'saveDeferred', array('item' => $item), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->saveDeferred($item);
    }

    public function enableVersioning(bool $enable = true)
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'enableVersioning', array('enable' => $enable), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->enableVersioning($enable);
    }

    public function reset()
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'reset', array(), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->reset();
    }

    public function setLogger(\Psr\Log\LoggerInterface $logger)
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'setLogger', array('logger' => $logger), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->setLogger($logger);
    }

    public function setCallbackWrapper(?callable $callbackWrapper) : callable
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'setCallbackWrapper', array('callbackWrapper' => $callbackWrapper), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->setCallbackWrapper($callbackWrapper);
    }

    public function get(string $key, callable $callback, ?float $beta = null, ?array &$metadata = null)
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'get', array('key' => $key, 'callback' => $callback, 'beta' => $beta, 'metadata' => $metadata), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->get($key, $callback, $beta, $metadata);
    }

    public function delete(string $key) : bool
    {
        $this->initializer48db7 && ($this->initializer48db7->__invoke($valueHolder0761d, $this, 'delete', array('key' => $key), $this->initializer48db7) || 1) && $this->valueHolder0761d = $valueHolder0761d;

        return $this->valueHolder0761d->delete($key);
    }
    ...
    public function __construct($redis, string $namespace = '', int $defaultLifetime = 0, ?\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        ...
        $this->valueHolder0761d->__construct($redis, $namespace, $defaultLifetime, $marshaller);
    }
    ...
    {
        $this->initializer48db7 || $this->valueHolder0761d->__destruct();
    }
}
