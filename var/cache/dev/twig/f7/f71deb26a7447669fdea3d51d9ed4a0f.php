...
class __TwigTemplate_3df33c2f8e60a9e4872af8ba4dd8ee36 extends Template
{
    private $source;
    private $macros = [];
    ...
    {% for trackedCode in trackedCodes %}
        {{ trackedCode | raw }}
    {% endfor %}
</script>", "@PimcoreCore/Analytics/Tracking/GoogleTagManager/dataLayer.html.twig", "/var/www/html/pimcore/main_project/vendor/pimcore/pimcore/bundles/CoreBundle/Resources/views/Analytics/Tracking/GoogleTagManager/dataLayer.html.twig");
    }
