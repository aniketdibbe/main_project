...
class __TwigTemplate_77bc6c2e6d04b117670d6ad777fdcd7c extends Template
{
    private $source;
    private $macros = [];
    ...
    {% for trackedCode in trackedCodes %}
        {{ trackedCode | raw }}
    {% endfor %}
</script>", "@PimcoreCore/Analytics/Tracking/GoogleTagManager/dataLayer.html.twig", "/var/www/html/new/main_project/vendor/pimcore/pimcore/bundles/CoreBundle/Resources/views/Analytics/Tracking/GoogleTagManager/dataLayer.html.twig");
    }
