...
class __TwigTemplate_6ce69c9fdf293aa45ea48bc9657e122d extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    ...
    {% include '@PimcoreAdmin/SearchAdmin/Search/Quicksearch/info-table.html.twig' with {'element': element} %}
{% endif %}
", "@PimcoreAdmin/SearchAdmin/Search/Quicksearch/document.html.twig", "/var/www/html/pimcore/main_project/vendor/pimcore/pimcore/bundles/AdminBundle/Resources/views/SearchAdmin/Search/Quicksearch/document.html.twig");
    }
