...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'console.command.public_alias.App\\Command\\Footwearinsert' => 'getFootwearinsertService',
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JkDg-w2YQO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($this->parameters['doctrine.dbal.connection_factory.types']))->createConnection(['driver' => 'pdo_mysql', 'charset' => 'UTF8MB4', 'host' => 'localhost', 'port' => 3306, 'user' => 'pimcore', 'password' => 'ROOT', 'dbname' => 'main_project_database', 'driverOptions' => [1002 => 'SET sql_mode = \'\';'], 'wrapperClass' => '\\Pimcore\\Db\\Connection', 'serverVersion' => '8.0.31-0ubuntu0.20.04.2', 'defaultTableOptions' => ['charset' => 'UTF8MB4', 'engine' => 'InnoDB', 'collate' => 'utf8mb4_general_ci']], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Aw6CU79veU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pNQQ7fKCGe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oNQpK23OKW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('izgY+U6p8R', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kPM29ZjOX2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->services['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getPimcore_Cache_Adapter_RedisTagAware_RecorderInnerService($lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Cache\Adapter\RedisTagAwareAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection('redis://localhost', ['lazy' => true]), 'fUpkGTPnZQ', 0, new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.App\\Command\\Footwearinsert',
                1 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Bundle\\ListCommand',
                2 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\CacheWarmingCommand',
                3 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ClassesDefinitionsBuildCommand',
                ...
                19 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Migrate\\StorageCommand',
                20 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Migrate\\ThumbnailsFolderStructureCommand',
                21 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\MysqlToolsCommand',
                22 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\RecyclebinCleanupCommand',
                23 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\RequirementsCheckCommand',
                24 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ResetPasswordCommand',
                25 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\RunScriptCommand',
                26 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\SearchBackendReindexCommand',
                27 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ThumbnailsClearCommand',
                28 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ThumbnailsImageCommand',
                29 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ThumbnailsVideoCommand',
            ],
        ];
    }
