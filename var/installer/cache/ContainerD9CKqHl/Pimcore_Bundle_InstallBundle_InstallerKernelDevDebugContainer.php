...
class Pimcore_Bundle_InstallBundle_InstallerKernelDevDebugContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XW+-6QPQ6K', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'installer-63b3c0917a85a6.74598868',
            ...
            'kernel.secret' => 'installer-63b3c0917a85a6.74598868',
