...
*/
public function getClothing(): ?\Pimcore\Model\DataObject\Classificationstore
{
	if ($this instanceof PreGetValueHookInterface && !\Pimcore::inAdmin()) {
		$preValue = $this->preGetValue("clothing");
		if ($preValue !== null) {
			return $preValue;
		}
	}

	$data = $this->getClass()->getFieldDefinition("clothing")->preGetData($this);
...
* @param \Pimcore\Model\DataObject\Classificationstore|null $clothing
* @return \Pimcore\Model\DataObject\Clothing
*/
public function setClothing(?\Pimcore\Model\DataObject\Classificationstore $clothing)
{
